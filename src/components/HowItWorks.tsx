...
export default function HowItWorks() {
  return (
    <section className="max-w-5xl mx-auto section-spacing section-pad-resp text-center">
      <h2 className="text-4xl font-bold mb-6">How It Works</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
        <div className="p-6 rounded-xl shadow bg-white/5 hover:bg-white/10 transition-colors duration-300">
