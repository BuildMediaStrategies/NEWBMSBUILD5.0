...
import { Thermometer, Clock, Phone, ArrowRight } from 'lucide-react';

export default function HVACEngineers() {
  ...
  return (
    <>
      <Helmet>
        <title>HVAC Engineers – Automated Systems for Heating Companies | BuildMediaStrategies</title>
        <meta name="description" content="Automation systems for UK HVAC engineers. Heating emergencies prioritized and scheduled instantly." />
      </Helmet>
      <div className="bg-black text-white min-h-screen pt-20">
        ...
        <section ref={ref} className="py-32">
          <div className="max-w-7xl mx-auto section-pad-resp text-center">
            ...
            >
              Automation Systems for <span className="gradient-text gradient-safe">HVAC Engineers</span>
            </motion.h1>
            ...
            >
              Heating emergencies prioritized and scheduled instantly. Never miss urgent callouts in winter.
            </motion.p>
          ...
          <div className="max-w-4xl mx-auto section-pad-resp text-center">
            ...
            >
              ...
              <p className="p-resp text-gray-400 mb-8">
                We're building specialized automation systems for HVAC engineers. 
