...
import { Zap, Clock, Phone, ArrowRight } from 'lucide-react';
...
export default function Electricians() {
  ...
  return (
    <>
      <Helmet>
        <title>Electricians – Automated Systems for Electrical Contractors | BuildMediaStrategies</title>
        <meta name="description" content="Automation systems for UK electricians. Quote emergency jobs in minutes, handle callouts 24/7, and never miss another electrical job." />
      </Helmet>
      <div className="bg-black text-white min-h-screen pt-20">
        ...
        <section ref={ref} className="py-32">
          <div className="max-w-7xl mx-auto section-pad-resp text-center">
            ...
            >
              Automation Systems for <span className="gradient-text gradient-safe">Electricians</span>
            </motion.h1>
            ...
            >
              Quote emergency jobs in 5 minutes, even at midnight. Handle callouts automatically while you focus on the electrical work.
            </motion.p>
          ...
          <div className="max-w-4xl mx-auto section-pad-resp text-center">
            ...
            >
              ...
              <p className="p-resp text-gray-400 mb-8">
                We're building specialized automation systems for electrical contractors. 
