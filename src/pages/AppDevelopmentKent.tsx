...
export default function AppDevelopmentKent() {
  ...
  return (
    <>
      <SEOHead
        title="App Development Kent | Mobile & Web Apps Dover"
        description="App Development in Kent, Dover & Canterbury. Mobile and web applications for Kent businesses. Custom app solutions across all Kent areas."
        canonical="/app-development-kent"
      />
      <LocalBusinessSchema />
