...
import { Trees, Calendar, Users, ArrowRight } from 'lucide-react';
...
export default function Landscapers() {
  ...
  return (
    <>
      <Helmet>
        <title>Landscapers – Automated Systems for Landscaping Companies | BuildMediaStrategies</title>
        <meta name="description" content="Automation systems for UK landscapers. Seasonal bookings managed automatically year-round." />
      </Helmet>
      <div className="bg-black text-white min-h-screen pt-20">
        ...
        <section ref={ref} className="py-32">
          <div className="max-w-7xl mx-auto section-pad-resp text-center">
            ...
            >
              Automation Systems for <span className="gradient-text gradient-safe">Landscapers</span>
            </motion.h1>
            ...
            >
              Seasonal bookings managed automatically year-round. Keep your schedule full through every season.
            </motion.p>
          ...
          <div className="max-w-4xl mx-auto section-pad-resp text-center">
            ...
            >
              ...
              <p className="p-resp text-gray-400 mb-8">
                We're building specialized automation systems for landscaping companies. 
