...
export default function SecurityCCTV() {
  ...
  return (
    <>
      <Helmet>
        <title>Security & CCTV – Automated Systems for Security Companies | BuildMediaStrategies</title>
        <meta name="description" content="Automation systems for UK security and CCTV companies. Handle urgent callouts automatically, even while you sleep." />
      </Helmet>
      <div className="bg-black text-white min-h-screen pt-20">
        ...
        <section ref={ref} className="py-32">
          <div className="max-w-7xl mx-auto section-pad-resp text-center">
            ...
            >
              Automation Systems for <span className="gradient-text gradient-safe">Security & CCTV</span>
            </motion.h1>
            ...
            >
              Urgent callouts handled while you sleep. Emergency response quotes sent instantly, 24/7 availability guaranteed.
            </motion.p>
          ...
          <div className="max-w-4xl mx-auto section-pad-resp text-center">
            ...
            >
              ...
              <p className="p-resp text-gray-400 mb-8">
                We're building specialized automation systems for security and CCTV companies. 
