...
import { HardHat, Clock, Users, ArrowRight } from 'lucide-react';
...
export default function Builders() {
  ...
  return (
    <>
      <Helmet>
        <title>Builders – Automated Systems for Building Companies | BuildMediaStrategies</title>
        <meta name="description" content="Automation systems for UK builders. Project quotes generated while you're on other sites." />
      </Helmet>
      <div className="bg-black text-white min-h-screen pt-20">
        ...
        <section ref={ref} className="py-32">
          <div className="max-w-7xl mx-auto section-pad-resp text-center">
            ...
            >
              Automation Systems for <span className="gradient-text gradient-safe">Builders</span>
            </motion.h1>
            ...
            >
              Project quotes generated while you're on other sites. Keep your pipeline full without the admin work.
            </motion.p>
          ...
          <div className="max-w-4xl mx-auto section-pad-resp text-center">
            ...
            >
              ...
              <p className="p-resp text-gray-400 mb-8">
                We're building specialized automation systems for building companies. 
