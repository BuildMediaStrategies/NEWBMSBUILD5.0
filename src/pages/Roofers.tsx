...
import { Home, Cloud, Phone, ArrowRight } from 'lucide-react';
...
export default function Roofers() {
  ...
  return (
    <>
      <Helmet>
        <title>Roofers – Automated Systems for Roofing Companies | BuildMediaStrategies</title>
        <meta name="description" content="Automation systems for UK roofers. Weather damage leads captured instantly after storms." />
      </Helmet>
        ...
        <section ref={ref} className="py-32">
          <div className="max-w-7xl mx-auto section-pad-resp text-center">
            <motion.div
              ...
              className="mb-6"
            >
              <div className="w-16 h-16 mx-auto mb-6 rounded-xl bg-gradient-to-r from-slate-600 to-gray-600 p-4">
            ...
            >
              Automation Systems for <span className="gradient-text gradient-safe">Roofers</span>
            </motion.h1>
            ...
            >
              Weather damage leads captured instantly after storms. Be first to respond when roofs need repair.
            </motion.p>
          ...
          <div className="max-w-4xl mx-auto section-pad-resp text-center">
            ...
            >
              ...
              <p className="p-resp text-gray-400 mb-8">
                We're building specialized automation systems for roofing companies. 
