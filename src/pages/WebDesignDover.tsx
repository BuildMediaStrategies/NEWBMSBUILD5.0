      ...
      <div className="bg-black text-white min-h-screen pt-20">
        ...
        <section ref={ref} className="py-32">
          <div className="max-w-7xl mx-auto section-pad-resp text-center">
            ...
            >
              Web Design <span className="gradient-text gradient-safe">Dover</span>
            </motion.h1>
            ...
            >
              <ResponsiveText
                short="Modern, responsive websites for Dover businesses."
                long="Professional web design services in Dover. We create modern, responsive websites that drive results for local businesses."
              />
            </motion.p>
          </div>
        </section>
        ...
        <section className="py-20">
          <div className="max-w-4xl mx-auto section-pad-resp text-center">
            ...
            <p className="p-resp text-gray-400 mb-8">Let's create something amazing for your Dover business</p>
            <Link to="/contact">
              <motion.button
